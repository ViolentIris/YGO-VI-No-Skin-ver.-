...
bool Game::Initialize() {
	...
	btnREP = env->addButton(rect<s32>(10, 170, 270, 200), wMainMenu, BUTTON_REP, dataManager.GetSysString(1288));
	...
	env->addStaticText(dataManager.GetSysString(1285), rect<s32>(20, 25, 130, 55), false, false, wSearchWindow);
...
void Game::OnResize() {
	...
	wANCard->setRelativePosition(ResizeWin(430, 170, 640, 370));
	...
	btnCardSearch->setRelativePosition(Resize(165, 270, 275, 305));
