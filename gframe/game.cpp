...
void Game::OnResize() {
	...
	btnCategoryOK->setRelativePosition(ResizeCardMid(135, 175, 235, 200, 235, 200));
	for(int i = 0; i < 32; ++i)
		chkCategory[i]->setRelativePosition(ResizeCardMid(10 + (i % 4) * 90, 10 + (i / 4) * 20, 100 + (i % 4) * 90, 30 + (i / 4) * 20));
